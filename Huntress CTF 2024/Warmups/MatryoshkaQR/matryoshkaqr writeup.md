...
We downloaded a file named qrcode.png, once scanning the code we found a binary data which was like this
...
**Wrote a small python script to get the flag in the png format**
...
# Then use an image viewer or Python's PIL library to open it
...
decoded_image.png will be opened once scanning that file we get the flag. 
